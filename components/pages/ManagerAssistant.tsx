...
import { FiTrendingUp, FiClipboard, FiActivity, FiArrowLeft, FiMail } from 'react-icons/fi';
  ...
  const features = [
    {
      ...
      description: 'Collects updates from your team asynchronously and compiles summaries.',
      gradient: 'from-purple-600 to-pink-600',
    },
    {
      icon: <FiActivity className="text-2xl" />,
      title: 'Project Tracking',
      description: 'Monitors deadlines and flags blockers before they become problems.',
      gradient: 'from-pink-600 to-blue-600',
    },
    {
      icon: <FiTrendingUp className="text-2xl" />,
      title: 'Performance Insights',
      description: 'Data-driven insights to help you coach your team better.',
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5 pointer-events-none">
        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect width="100%" height="100%" fill="url(#manager-hexagons)" />
        </svg>
      </div>
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10">
        ...
        <div className="text-center">
          ...
          <p className="animate-on-scroll text-xl md:text-2xl text-slate-300 mb-16 max-w-3xl mx-auto leading-relaxed">
            Stop chasing status updates. Your AI Manager Assistant tracks
            projects, runs standups, and drafts reports automatically.
          </p>
          ...
          <div className="animate-on-scroll grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="p-6 rounded-xl bg-slate-900/50 border border-purple-500/20">
              ...
              <div className="text-sm text-slate-400">Less Admin Work</div>
            </div>
            <div className="p-6 rounded-xl bg-slate-900/50 border border-purple-500/20">
              <div className="text-4xl font-bold bg-gradient-to-r from-pink-400 to-blue-400 bg-clip-text text-transparent mb-2">
                100%
              </div>
              <div className="text-sm text-slate-400">Team Coverage</div>
            </div>
            <div className="p-6 rounded-xl bg-slate-900/50 border border-purple-500/20">
          ...
          <div className="animate-on-scroll p-10 rounded-2xl bg-gradient-to-br from-purple-950/50 via-pink-950/30 to-blue-950/50 backdrop-blur-sm border border-purple-500/30 max-w-2xl mx-auto shadow-2xl shadow-purple-500/10">
            ...
            <p className="text-slate-300 mb-8 text-lg">
              Be the first to know when the Manager Assistant launches. Join our
              exclusive waitlist.
            </p>
          ...
          <p className="animate-on-scroll text-sm text-slate-500 mt-8">
            Expected launch: Q3 2026 • Limited early access available
          </p>
        </div>
      </div>
